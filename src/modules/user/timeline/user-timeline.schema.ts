...
export const UserTimelineQuerySchema = z.object({
    ...
    includeOfficeReservations: z
        ...
        .default(true),
    officeCategories: z
        .preprocess(normalizeCsvList, z.array(ReservationCategorySchema).optional())
        .optional(),
    includeParkingReservations: z
        .preprocess((v) => v === 'true' || v === true, z.boolean())
        .default(true),
    includeEvents: z.preprocess((v) => v === 'true' || v === true, z.boolean()).default(false),
    includeFriends: z.preprocess((v) => v === 'true' || v === true, z.boolean()).default(false),
    includeEIds: z
