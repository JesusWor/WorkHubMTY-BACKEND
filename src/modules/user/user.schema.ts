...
export const UserRelationExcludeSchema = z.enum(["friends", "sent_requests", "received_requests"]);
...
export const ListUsersQuerySchema = z.object({
    ...
    exclude: z.preprocess(normalizeCsvList, z.array(UserRelationExcludeSchema).default([])),
    excludeId: z.preprocess(normalizeCsvList, z.array(z.string().min(1)).default([])),
