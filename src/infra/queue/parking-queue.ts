...
export const parkingQueue = new Queue<NoShowJobData>(PARKING_QUEUE_NAME, {
    connection,
    defaultJobOptions: {
        attempts: 3,
        backoff: { type: "exponential", delay: 5_000 },
        removeOnComplete: { count: 100 },   // retiene los últimos 100 jobs completados
        removeOnFail: { count: 200 },    // retiene los últimos 200 jobs fallidos
    },
});
